...
def remove_item(user_id, item_id):
   old_item = Item.query.get(item_id)#from the Item model, fetch the item with primary key item_id to be deleted
...
def dashboard():
  ...
  if request.method == 'POST' and form.validate():
    new_song2 = Song(artist = form.artist.data ,title = form.title.data, n = 1)
